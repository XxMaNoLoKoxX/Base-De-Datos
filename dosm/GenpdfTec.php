...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 10, 'Listado de Tecnicos', 0, 1, 'C');
        $this->Ln(10);
    }
...
$widths = [15, 30, 30, 50, 40]; // Anchos de las columnas
$headers = ['ID', 'Nombre', 'Telefono', 'Email', 'Especialidad'];
...
$query = "SELECT * FROM Técnicos"; // Cambia la tabla según sea necesario
